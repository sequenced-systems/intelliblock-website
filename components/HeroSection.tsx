...
const TICKER_ITEMS = [
  { label: 'BAKASSI DSP', score: '80.0', delta: '+2.4', positive: true },
...
// Semicircle arc: M 14 124 A 96 96 0 0 1 206 124
// Arc length = π × 96 ≈ 301.6
// 80/100 filled = 241.3
      ...
      <div className="ib-hero__inner">
        <div className="ib-hero__grid">
          ...
          <div className="ib-hero__left">
            <div className="ib-chip">Nigeria Infrastructure Intelligence / V3.2</div>
                ...
                {DIMENSIONS.map(dim => (
                  <div key={dim.code} className="ib-dim">
                    ...
                    <div className="ib-dim__track" role="progressbar" aria-valuenow={dim.pct} aria-valuemin={0} aria-valuemax={100}>
                      <div className="ib-dim__fill" style={{ width: `${dim.pct}%` }} />
                    </div>
                  </div>
                ))}
              </div>
